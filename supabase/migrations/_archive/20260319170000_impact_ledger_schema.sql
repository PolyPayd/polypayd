-- Ensures impact_ledger, impact_distributions, and apply_impact_from_platform_fee exist.
-- Use when live DB has the payout RPCs but missing Impact tables.
...
comment on table public.impact_ledger is
  'Records impact pool credits: slice of platform fee per batch ledger transaction.';
